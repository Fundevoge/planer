...
class ColorPicker extends StatefulWidget {
  const ColorPicker({
    ...
    required this.sharedColorHistory,
    required this.uniqueHistoryColor,
  }) : super(key: key);
  ...
  final Color uniqueHistoryColor;
  final List<Color> sharedColorHistory;
...
class _ColorPickerState extends State<ColorPicker> {
  ...
  void initState() {
    ...
    colorHistory = <Color>[widget.uniqueHistoryColor] + widget.sharedColorHistory;
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    if (!colorHistory.contains(currentHsvColor.toColor())) {
                      setState(() {
                        colorHistory.insert(1, currentHsvColor.toColor());
                      });
                      widget.sharedColorHistory.insert(0, currentHsvColor.toColor());
                    }
                  },
